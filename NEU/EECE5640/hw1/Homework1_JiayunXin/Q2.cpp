/*
 *  code source: https://malithjayaweera.com/2019/02/parallel-merge-sort/
 *  Parallel Merge Sort
...
int main(int argc, const char * argv[]) {
    ...
    printf("Run program with %d thread(s)\n", NUM_THREADS);
    printf("Time taken for execution: %f seconds\n", time_spent);
    /* test to ensure that the array is in sorted order and print*/
